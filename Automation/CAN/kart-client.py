...
#                                                                               #
# This script is a simple command-line interface for sending CAN messages to a  #
# VESC motor controller. It allows the user to send duty cycle and current      #
# commands, and to receive status messages.                                     #
#                                                                               #
